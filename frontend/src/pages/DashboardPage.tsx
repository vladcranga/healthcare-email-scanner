      ...
      <div className="py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <dl className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-8">
            ...
            <StatCard 
              title="Safe Emails" 
              value={Math.max(0, stats.total_emails - stats.suspicious_emails - stats.high_risk_emails)}
              icon={<FaShieldAlt />} 
            />
            <StatCard 
              ...
              <div className="space-y-2">
                ...
                <div className="flex space-x-2 mb-4">
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-md ${
                      statusFilter === 'safe' ? 'bg-green-500 text-white' : 'bg-gray-200 text-gray-700'
                    }`}
                  >
                    Safe
                  </button>
                  <button
                    ...
                    className={`px-4 py-2 rounded-md ${
                      statusFilter === 'suspicious' ? 'bg-yellow-500 text-white' : 'bg-gray-200 text-gray-700'
                    }`}
                  >
                    Suspicious
                  </button>
                  <button
                    onClick={() => { setStatusFilter('dangerous'); setCurrentPage(1); }}
                    className={`px-4 py-2 rounded-md ${
                      statusFilter === 'dangerous' ? 'bg-red-500 text-white' : 'bg-gray-200 text-gray-700'
                    }`}
                  >
                    Dangerous
                  </button>
